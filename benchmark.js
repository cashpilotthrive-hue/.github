...
// Warm up
strategyEngine.optimize('martingale', crashPoints, 1000, 10);

const iterations = 100;
const start = Date.now();
strategyEngine.optimize('martingale', crashPoints, 1000, iterations);
const end = Date.now();

console.log(`Optimization with ${iterations} iterations and 1000 crash points took ${end - start}ms`);
