...
class StrategyEngine {
  ...
  optimize(strategyKey, crashPoints, bankroll = 1000, iterations = 50) {
    ...
    for (let i = 0; i < iterations; i++) {
      ...
      try {
        // BOLT OPTIMIZATION: Skip results array creation during optimization iterations
    ...
    // BOLT OPTIMIZATION: Final backtest with best parameters to include results for UI charting
    if (bestParams) {
