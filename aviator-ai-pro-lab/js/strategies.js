...
class StrategyEngine {
  ...
  _aiAnalyze(state) {
    ...
    // BOLT OPTIMIZATION: Single O(N) pass to compute sum, sum of squares, recent sum,
    // and low-crash counts. Completely avoids array allocations (.slice, .filter)
    ...
    const avg = sum / len;
    const rawVariance = (sumSq / len) - (avg * avg);
