...
class StrategyEngine {
  ...
  _aiAnalyze(state) {
    ...
    let sum = 0, recentSum = 0, lowCrashCount = 0;
    ...
    // Variance still needs avg, so we do one more pass or use sum of squares
    let varianceSum = 0;
    for (let i = 0; i < len; i++) {
    ...
    // BOLT OPTIMIZATION: Use faster mathematical rounding instead of toFixed().
    return {
