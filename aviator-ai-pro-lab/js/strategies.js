...
class StrategyEngine {
  ...
  optimize(strategyKey, crashPoints, bankroll = 1000, iterations = 50) {
    ...
    for (let i = 0; i < iterations; i++) {
      ...
      try {
        // BOLT OPTIMIZATION: Skip result array generation during iterative optimization
    ...
    // Restore original and then run one final backtest with full results for the best params
