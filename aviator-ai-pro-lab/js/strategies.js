...
class StrategyEngine {
  ...
  backtest(strategyKey, crashPoints, bankroll = 1000) {
    ...
    // Performance metrics tracked in single pass
    let wins = 0;
    ...
    return {
      ...
      totalProfit: Math.round((currentBankroll - bankroll) * 100) / 100,
      roi: Math.round(((currentBankroll - bankroll) / bankroll * 100) * 100) / 100,
