...
class StrategyEngine {
  ...
  _aiAnalyze(state) {
    ...
    // BOLT OPTIMIZATION: Calculate average, recent average, and low crash ratio in a single pass
    // to avoid redundant array allocations (slice/filter) and multiple reduce callback iterations.
    let sum = 0;
    let lowCrashCount = 0;
    let recentSum = 0;
    ...
    // BOLT OPTIMIZATION: Use Math.round instead of parseFloat(toFixed()) string conversions
    return {
