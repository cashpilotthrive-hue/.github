...
class StrategyEngine {
   ...
   * BOLT OPTIMIZATION: includeResults=false skips building the large results array
   * during intensive operations like optimization to save memory and time.
   */
  ...
  _aiAnalyze(state) {
    ...
    return {
      ...
      // BOLT OPTIMIZATION: Math.round is significantly faster than toFixed()
