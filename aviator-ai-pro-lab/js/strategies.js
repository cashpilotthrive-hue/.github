...
class StrategyEngine {
  ...
  _aiAnalyze(state) {
    ...
    // Single-pass calculation of avg, variance, recentAvg, and lowCrashRatio
  ...
  optimize(strategyKey, crashPoints, bankroll = 1000, iterations = 50) {
    ...
    for (let i = 0; i < iterations; i++) {
      // Use originalParams as consistent base to prevent randomized parameter drift
    ...
    // Run a final high-fidelity backtest with includeResults: true using the best identified parameters
    if (bestParams) {
