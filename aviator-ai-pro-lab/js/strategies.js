...
class StrategyEngine {
  ...
  optimize(strategyKey, crashPoints, bankroll = 1000, iterations = 50) {
    ...
    for (let i = 0; i < iterations; i++) {
      ...
      try {
        // BOLT OPTIMIZATION: Skip generating detailed results for each iteration to save CPU/memory
    ...
    // Final high-fidelity backtest for the best found parameters to get full results
    if (bestParams) {
