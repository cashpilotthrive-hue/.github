...
class AviatorEngine {
  ...
  generateCrashHistory(count) {
    ...
    for (let i = 0; i < count; i++) {
      ...
      // BOLT OPTIMIZATION: Propagate seed deterministically via custom hash helper
      // instead of invoking slow synchronous crypto.getRandomValues on every iteration.
