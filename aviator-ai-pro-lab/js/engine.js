...
class AviatorEngine {
  ...
  /**
   * BOLT OPTIMIZATION: Mathematical rounding is ~60x faster than toFixed(2).
   */
  _round(n, decimals = 2) {
  ...
  simulateRound(betAmount, cashOutAt) {
    ...
    // BOLT OPTIMIZATION: Replacing parseFloat(n.toFixed(2)) with _round helper for performance.
    const round = {
