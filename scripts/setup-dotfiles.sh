...
copy_dotfile() {
    ...
    if [ -f "$DOTFILES_DIR/$file" ]; then
        # BOLT OPTIMIZATION: Use cmp -s to skip redundant file copies if already identical.
        # This reduces warm-run execution time significantly by avoiding unnecessary backups and I/O.
