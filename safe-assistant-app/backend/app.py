...
class ChatMessage(BaseModel):
    # BOLT OPTIMIZATION: Use Literal for faster validation of fixed string values
    # compared to regex-based 'pattern' validation.
...
def chat(payload: ChatRequest) -> ChatResponse:
    ...
    # BOLT OPTIMIZATION: Lowercase the content once and reuse it for both
    # moderation and tool triggering to avoid redundant O(N) string operations.
