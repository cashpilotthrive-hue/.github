...
def _moderate_content(content: str, lowered_content: str | None = None) -> ModerationResponse:
    lowered = lowered_content or content.lower()
...
def chat(payload: ChatRequest) -> ChatResponse:
    ...
    # BOLT OPTIMIZATION: Reuse pre-lowered user message for moderation and tool checks
    # to avoid redundant string manipulation overhead, especially for large payloads.
