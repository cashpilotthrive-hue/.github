...
class ChatMessage(BaseModel):
    # BOLT OPTIMIZATION: Using Literal instead of regex pattern for faster validation
    # of a fixed set of allowed string values in Pydantic.
...
def _moderate_content(content: str, lowered_content: Optional[str] = None) -> ModerationResponse:
    """Internal helper to moderate content, allowing reuse of a pre-lowered string."""
...
def chat(payload: ChatRequest) -> ChatResponse:
    ...
    # BOLT OPTIMIZATION: Pre-lower the user message once and reuse it for
    # both moderation and tool triggering logic, avoiding redundant string copies.
