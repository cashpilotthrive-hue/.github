...
def upload_file(file: UploadFile = File(...)) -> dict[str, Any]:
    fid = str(uuid.uuid4())
    # BOLT OPTIMIZATION: Use a synchronous handler and seek-based size detection.
    # Defining this as 'def' instead of 'async def' allows FastAPI to offload the
    # synchronous file I/O to a thread pool, preventing event loop blockage and
    # significantly improving concurrency.
