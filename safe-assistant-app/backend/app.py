...
def _moderate_content(content: str, lowered_content: Optional[str] = None) -> ModerationResponse:
    """Internal helper for moderation, allows reusing lowered content."""
...
def chat(payload: ChatRequest) -> ChatResponse:
    ...
    # BOLT OPTIMIZATION: Lowercase the message once and reuse it for moderation and tool checks.
    # This improves latency, especially for large payloads.
