...
def _moderate_content(content: str, lowered_content: str | None = None) -> ModerationResponse:
    """Helper for moderation that allows reuse of lowered content string."""
...
def chat(payload: ChatRequest) -> ChatResponse:
    ...
    # BOLT OPTIMIZATION: Compute lowered content once and reuse it for moderation and tool checks.
