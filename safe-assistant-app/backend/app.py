...
def call_all_features_response(payload: AllFeaturesRequest) -> dict[str, Any]:
    ...
    tool_result = run_tool(ToolRunRequest(name="summarize_text", args={"text": payload.message}))
