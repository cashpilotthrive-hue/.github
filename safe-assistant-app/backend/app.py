...
class ChatMessage(BaseModel):
    ...
    # improves performance as it avoids regex engine overhead for a fixed set of strings.
...
def _moderate_content(content: str, lowered_content: str | None = None) -> ModerationResponse:
    """Helper to moderate content, optionally using a pre-lowered string."""
...
def chat(payload: ChatRequest) -> ChatResponse:
    ...
    # BOLT OPTIMIZATION: Pre-calculate the lowercase version of the user message
    # to avoid redundant .lower() calls during moderation and tool triggering logic.
