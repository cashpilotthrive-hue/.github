...
def _moderate_content(content: str, lowered_content: str | None = None) -> ModerationResponse:
    """Internal helper to moderate content, allowing reuse of already lowered strings."""
...
def chat(payload: ChatRequest) -> ChatResponse:
    ...
    # BOLT OPTIMIZATION: Reuse a single pre-lowered user message for moderation and tool checks.
    # This avoids redundant .lower() calls on potentially large user payloads, improving latency.
