...
def chat(payload: ChatRequest) -> ChatResponse:
    ...
    # BOLT OPTIMIZATION: Compute lowercase once for both moderation and tool checks.
    # Reusing the lowered string avoids redundant O(N) operations on potentially large messages.
    lowered_user_message = latest_user_message.lower()

    moderation = _moderate_content(latest_user_message, lowered_content=lowered_user_message)
