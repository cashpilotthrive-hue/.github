...
class ChatMessage(BaseModel):
    # BOLT OPTIMIZATION: Using typing.Literal instead of regex pattern for role validation.
    # This is significantly faster as it avoids regex engine overhead for a fixed set of strings.
...
def _moderate_content(content: str, lowered_content: str | None = None) -> ModerationResponse:
    """Helper for moderation that optionally accepts pre-lowered content."""
...
def chat(payload: ChatRequest) -> ChatResponse:
    ...
    # BOLT OPTIMIZATION: Compute the lowered user message once and reuse it
    # for both moderation and tool triggering logic.
    # This reduces redundant O(N) string processing.
