...
class LoadBalancer:
    ...
    def route_request(self, request_id, processing_time):
        ...
        if server:
            # BOLT: Moved outside the LB lock to reduce contention and allow concurrent requests across servers.
            # The Server instance is responsible for checking its own capacity under its own lock.
